...
Fiz o uso de duas bibliotecas, para facilitar o processo de análise do banco de dados utilizamos do pandas, biblioteca conhecida em python para análise de dados, e para usar da função exit() no notebook utilizei da biblioteca sys que possibilita a utilização de várias funções para o sistema.
